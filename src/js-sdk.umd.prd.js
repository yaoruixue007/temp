...
;(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : ((global = typeof globalThis !== 'undefined' ? globalThis : global || self),
      factory((global['@lightapp-engine/js-sdk'] = {})))
  ...
  ***************************************************************************** */
  ...
  var defaultUrl = ''
    .concat(protocol, '//')
    .concat(host, ':')
    .concat(port, '/api/light-app/transmit')
  var Upload = function (post) {
  ...
  var parse = function () {
    ...
    if (search.length <= 1) {
      throw Error('未提供token信息')
    }
    var params = search[1]
    var token = (queryParse(params) || {}).token
